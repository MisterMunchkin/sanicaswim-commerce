  ...
  render() {
    ...
    return (
      <div
        ...
        <div
          className={`dropdown rounded-sm bg-white d-flex align-items-center justify-content-between ${isOpen &&
            'border-color-black'}`}
        >
          <p className="font-color-medium">{this.props.displayName || this.props.value || this.props.placeholder }</p>
          <Image
